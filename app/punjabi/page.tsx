      ...
      <section className="section" style={{ paddingTop: 36 }}>
        <div className="container reading">
          <div className="prose">
            ...
            <p>
              ਹਰ ਸੈਸ਼ਨ 50 ਮਿੰਟ ਦਾ ਹੁੰਦਾ ਹੈ। ਪਹਿਲਾਂ 30 ਮਿੰਟ ਦੀ ਮੁਫ਼ਤ ਗੱਲਬਾਤ ਹੁੰਦੀ ਹੈ ਤਾਂ ਜੋ ਤੁਸੀਂ ਦੇਖ ਸਕੋ ਕਿ
            ...
            <h2>ਅਗਲਾ ਕਦਮ</h2>
            <p>
              ਪਹਿਲੀ ਗੱਲਬਾਤ 30 ਮਿੰਟ ਦੀ ਹੈ, ਮੁਫ਼ਤ ਹੈ, ਅਤੇ ਇਸ ਤੋਂ ਬਾਅਦ ਕੁਝ ਵੀ ਕਰਨਾ ਜ਼ਰੂਰੀ ਨਹੀਂ। ਜੇ ਲੱਗੇ ਕਿ ਕੋਈ
