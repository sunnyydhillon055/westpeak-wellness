# Fifty more — clicks, impressions, clients
...
1. **[me]** Guide: *EI sickness benefits and therapy* — how the 26 weeks actually work. (Stress-leave cluster, ~120 imps at pos 16–28, is the site's proven genre; this is its nearest unbuilt neighbour.)
2. **[me]** Guide: *Getting a doctor's note for a mental-health leave in BC* — the procedural query behind "how to apply for stress leave" (19 imps, pos 24).
3. **[me]** Guide: *Return-to-work after a mental-health leave* ("mental health accommodations at work", pos 43).
4. **[me]** Resource: *WorkSafeBC psychological-injury claims, explained* — work-caused vs work-affected, in the practicalities register.
...
12. **[me]** EMDR-online retarget: "emdr therapy online" (pos 88) — same treatment on the EMDR service page.

## B · SERP features and click-through (10)

13. **[me]** Featured-snippet pass: 40–60-word direct answers under exact-match H2s on the five page-2 pages (stress-leave, msp-vs-extended, workplace, RCC compare, verify).
14. **[me]** Numbered-steps formatting on every "how to" section (snippet + AI-answer extraction favour ordered lists).
15. **[me]** People-Also-Ask mining: pull PAA questions for the top 10 queries (browser session), add verbatim-phrased FAQs to the owning pages.
...
29. **[me]** Ten new standalone Q&As on /answers targeting PAA phrasings from item 15.
30. **[gated]** Punjabi-language expansion (more Gurmukhi surfaces) — highest-ceiling content on the site, gated on fluent-speaker review by standing rule.
...
35. **[both]** Community-org listings: CMHA BC branch resource pages, divisions of family practice, settlement agencies (Punjabi services angle). I compile the list + copy.
36. **[both]** South Asian podcast/radio outreach list (RED FM, Connect FM community programming) — the Punjabi differentiator is broadcast-shaped. I compile; owner records.
37. **[owner]** Bing Webmaster Tools verification — the site demonstrably ranks better on Bing's index (page 1 Punjabi positions); ten minutes for a whole second data stream.
38. **[owner]** Apple Business Connect listing — a second maps surface, free, no review pressure.
39. **[owner]** Abbotsford Chamber of Commerce membership — citation + local link + directory.
40. **[me]** Reels/Shorts script pack: 20 sub-60-second scripts generated from existing shortAnswers, BCACC-compliant, into the social queue.
41. **[both]** GP/clinic referral kit: the /refer page as a printable one-pager + cover email to Fraser Valley family practices. I build; owner sends.
42. **[owner]** Everything in PATH_TO_700 that is still unstarted — phone, GBP, Psychology Today, Facebook/LinkedIn, citations. Listed once, not re-counted as five.

## E · Conversion — turning the traffic into clients (8)
