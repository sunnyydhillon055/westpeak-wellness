...
**Re-audited:** 8 August 2026 — fifth measurement pass, after four complete build-and-verify cycles
...
**Westpeak Wellness: 9,110 / 10,000** — up 1,265 points from 7,845 at the first audit. Intermediate totals: 8,920 · 8,995 · 9,080.

| Rank | Site | Score | /10,000 |
|--:|---|--:|--:|
| 1 | **Westpeak Wellness** | **9,110** | 91.1% |
...
| 18 | Informational content depth | 250 | **395** | +145 |
| 1 | Indexable page count & coverage breadth | 175 | **285** | +110 |
...
|---|---|--:|--:|--:|--:|--:|--:|
| 1 | Indexable page count & coverage breadth | **285** | 460 | 470 | 410 | 320 | 360 |
...
| 18 | Informational content depth | **395** | 480 | 200 | 320 | 300 | 350 |
| 19 | Decision & comparison content | **480** | 260 | 180 | 220 | 150 | 200 |
| 20 | On-page E-E-A-T signals | **430** | 390 | 400 | 360 | 390 | 280 |
| | **TOTAL / 10,000** | **9,110** | 6,250 | 6,720 | 6,890 | 6,540 | 4,870 |

## Category detail

### 1. Indexable page count & coverage breadth

**Westpeak 285/500 — 🔴 **Behind**, ranked 6 of 6.** (+110 from 175)

Sitemap URLs: Alive 491, Well Beings 485, Upstream 405, Wellspring 307, Thrive 197, **Westpeak 86** — up from 48 at the first audit, a 79% increase. Discounted for low-value URLs: Alive carries 217 `/tag/` archives and Upstream has `/team-focus/` pages measured at 2 words. Every Westpeak URL is substantive; the thinnest page on the site is 704 words and 78 of 86 exceed 1,000.

### 2. Average content depth per page

**Westpeak 380/500 — 🟡 **Competitive**, ranked 4 of 6.** (+180 from 200)

Site-wide: **144,069 words across 86 pages, averaging 1,675**, with the 69 content pages averaging **1,790** — against 40,281 words across 48 pages averaging 839 at the first audit. The homepage alone went 708 to 1,366. On the four-page sampling used for the competitors, Westpeak measured 1,621–1,774 across repeat runs, against Upstream 2,666 · Well Beings 2,579 · Wellspring 2,049 · Thrive 1,463 · Alive 986. The site-wide figure is the more reliable of the two, since a four-page sample of an 86-page site carries real variance — which is a limitation of the method applied to every site here, not only this one.

### 3. Content uniqueness / duplication risk

**Westpeak 495/500 — 🟢 **Leading**, ranked 1 of 6.** (+15 from 480)

**15.5% maximum pairwise 5-gram overlap across all 86 pages, zero pairs above 25%** — and the figure *fell* while the corpus grew from 40,281 to 144,069 words, which is the harder result. The 48-page version scored 18.1%. Wellspring runs 99 templated `/service-areas/` pages including city×issue combinations; Well Beings repeats city variants; Alive exposes 217 tag archives.
...
**86/86 unique and ≤60 characters.** Sampled competitor ranges: Upstream 20–79 · Wellspring 52–75 · Well Beings 48–98 · Alive 44–114 · Thrive 76–96 (all over the limit).

### 7. Meta descriptions

**Westpeak 490/500 — 🟢 **Leading**, ranked 1 of 6.** (unchanged)

**86/86 unique, ≤155, none missing.** Upstream has no meta description on its homepage or any sampled page. Alive is missing them on all samples (home 319 chars). Thrive 75–158. Wellspring 156–185.
...
86/86 self-canonical, no duplicate titles or descriptions, generated social-card routes excluded from crawl, preview deployments set to noindex. **The Upstream homepage has no canonical.** Alive exposes 217 thin tag archives to the index.
...
**Was 0 of 48 pages carrying an og:image; now 86 of 86**, each a distinct 1200×630 card generated per route, with og:image:alt, explicit dimensions and twitter:summary_large_image. No og:image at Wellspring, Well Beings or Alive; Upstream has no OG tags at all; Thrive was the only competitor with a working one.

### 13. Page weight & Core Web Vitals risk

**Westpeak 470/500 — 🟢 **Leading**, ranked 1 of 6.** (-10 from 480)

Homepage HTML: **Westpeak 55 KB** — up from 31 KB after nearly doubling the homepage copy and adding full schema, still fully static with no third-party scripts, and still less than half the next lightest — against Upstream 108 KB · Alive 317 KB · Well Beings 385 KB · Thrive 403 KB · **Wellspring 930 KB**. All 74 images are SVG under 5 KB with intrinsic dimensions, so they contribute no layout shift.
...
Verified **3+ booking touchpoints on all 85 pages** — the single exception being /book itself, which is the booking page — all reading one configuration value. Competitors carry consultation CTAs but place them inconsistently.

### 18. Informational content depth

**Westpeak 395/500 — 🟡 **Competitive**, ranked 2 of 6.** (+145 from 250)

**31 guides (was 9), 8 comparisons, 9 BC resource pages, 9 audience pages and a 60-term glossary — roughly 100,000 words of informational content, up from about 12,000, at an average of 1,790 words per content page.** Still outgunned on volume: **Upstream runs 172 blog posts averaging ~3,700 words.** Nimble 121, Alive 79 resources, Wellspring ~29 categories.
...
**One category remains under 330: raw page count.** Westpeak publishes 86 pages against 197–491.
...
1,790-word average would mean roughly 200,000 further words of genuinely distinct content, which is
months of sustained publishing rather than a build pass.

Content depth is no longer a gap in the same way. At 1,790 words across all 69 content pages the
