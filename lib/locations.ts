...
export const locations: Location[] = [
  {
    ...
    metaDescription:
      "Online counselling for Prince George and Northern BC. EMDR, trauma, anxiety, and couples therapy by secure video, in English or Punjabi.",
    intro: [
...

  {
    ...
    metaDescription:
      "Online counselling for Vancouver, BC. EMDR, trauma, anxiety, depression, and couples therapy by secure video, in English or Punjabi.",
    intro: [
