...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    a: "Individual sessions are $150 for 50 minutes, couples are $170 for 50 minutes (or $340 for a 120-minute extended session), and EMDR intensives are $225 for 90 minutes. There is no GST on RCC counselling in BC. Full details are on the Fees page.",
  },
  {
