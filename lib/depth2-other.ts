  ...
  'compare/weekly-vs-biweekly-sessions': [
    {
      ...
      body: [
        'Breaks happen — holidays, work travel, money, a period where life has no room in it. Taken deliberately they cost little; taken by drift they frequently end the work entirely.',
        ...
        'It is also worth knowing which phases tolerate a break poorly. Mid-way through trauma reprocessing is the clearest case — a memory that has been opened and not fully processed is a bad thing to carry for six weeks. Where a break is unavoidable at that point, the work should be deliberately closed down first rather than paused mid-target, and a counsellor should raise that rather than agreeing to the dates.',
      ],
    },
  ],
  ...
  'for/university-students': [
    {
      ...
      body: [
        'A significant number of students arrive at counselling with a question that is not about mental health: should I still be doing this degree? It is a legitimate use of sessions and it is worth separating into its parts.',
        ...
        '**Whose decision would this be?** For many students, and disproportionately for first-generation students, the programme was chosen with heavy family involvement. Disentangling what you want from what was expected is difficult and it is exactly the kind of thing counselling is for.',
        '**What are the reversible and irreversible parts?** A leave of absence, a reduced load, a programme transfer and a withdrawal have different consequences, and most students do not know which of them are recoverable. The registrar and the accessibility office have those answers.',
