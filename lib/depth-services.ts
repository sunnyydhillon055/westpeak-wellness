  ...
  'services/punjabi-counselling': [
    {
      ...
      body: [
        ...
        '**Emotional vocabulary does not translate cleanly.** A great deal of what people bring to counselling was originally encoded in a particular language — the exact phrasing a parent used, the specific weight of an obligation, the joke that was not really a joke. Rendering that into English while simultaneously feeling it is genuinely demanding cognitive work, and it flattens the material. People frequently notice they are describing an event rather than being in it.',
  ...
  'services/online-counselling-bc': [
    {
      ...
      body: [
        ...
        '**Connection.** Video is preferable and not essential; a phone session is a real option rather than a failure state, and it suits some people better. Agreeing in advance what happens if the connection drops — usually a phone call to the same slot — removes a background anxiety that otherwise takes up part of every session.',
